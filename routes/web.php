...
Route::group(array('before' => 'guest'), function() {
	...
	// Add a route to reload captcha
     Route::get('/reload-captcha', 'AccountController@reloadCaptcha')->name('reload-captcha');

// Add your existing routes for account related actions here
